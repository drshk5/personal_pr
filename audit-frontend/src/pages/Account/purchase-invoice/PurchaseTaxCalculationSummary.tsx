...
interface PurchaseTaxCalculationSummaryProps {
...
export const PurchaseTaxCalculationSummary: React.FC<
  PurchaseTaxCalculationSummaryProps
> = ({ form, isFormDisabled, items, currencyLabel, partyWithLocations }) => {
  ...
  useEffect(() => {
    if (adjustmentAccountGUID) {
      setSelectedAccountGUID(adjustmentAccountGUID);
    }
  }, [adjustmentAccountGUID]);
  ...
  const hasVendor = !!selectedPartyGUID;
  const canCalculate = hasVendor && subtotal > 0;
  const shouldCalculateTax = hasTaxConfig && canCalculate;

  // Determine inter/intra state based on organization tax config state vs party billing state
  ...
  }, [taxBreakdown.totalTax, form, canCalculate, shouldCalculateTax]);
      ...
      <div className="w-full lg:w-1/2 ml-auto">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-xs">
                      <p className="text-xs">
                        Add any other +ve or -ve charges that need to be applied
                        to adjust the total amount of the transaction. Eg. +10
                        or -10.
                      </p>
                    </TooltipContent>
                  </Tooltip>
        ...
        {adjustmentAmt !== 0 &&
          ...
          adjustmentAmt !== undefined && (
            <div className="flex py-1 px-3 sm:px-4">
          ...
          <div className="space-y-4 py-4">
            <div>
              ...
              <PreloadedSelect
                ...
                selectedValue={selectedAccountGUID}
                onChange={setSelectedAccountGUID}
